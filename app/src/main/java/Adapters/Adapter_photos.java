...
public class Adapter_photos extends RecyclerView.Adapter<Adapter_photos.Adapter_recommendViewHolder> {

    Context mContext;

    public Adapter_photos(FragmentActivity activity) {
    ...
    public Adapter_recommendViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view  = LayoutInflater.from(mContext).inflate(R.layout.adapter_photos,null,false);
